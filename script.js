...
// ==================== 6. نموذج الطلب السريع (Quick Order Form فقط - الصفحة الرئيسية) ====================
// ملاحظة: نموذج /request له معالج مستقل داخل الصفحة (inline script)
// لذلك نتعامل هنا فقط مع نموذج الطلب السريع في الصفحة الرئيسية لتجنب التعارض
